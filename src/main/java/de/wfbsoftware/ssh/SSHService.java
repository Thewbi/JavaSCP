...
public interface SSHService extends FileSystemService {
	...
	void transfer(Session session, FileSystemNode fromFileSystemNode, FileSystemNode toFileSystemNode, boolean fromIsRemote) throws JSchException, SftpException;
